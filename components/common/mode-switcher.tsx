...
export function ModeSwitcher() {
  ...
  return (
    <div className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom)+0.5rem)] left-6 z-[100] md:right-6 md:bottom-6 md:left-auto">
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="border-border bg-surface-elevated shadow-elevated absolute bottom-14 left-0 mb-2 w-48 overflow-hidden rounded-xl border md:right-0 md:left-auto"
          >
